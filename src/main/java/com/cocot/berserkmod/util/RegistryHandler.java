...
import com.cocot.berserkmod.effects.SacrificeBrandEffect;
...
public class RegistryHandler {
    ...
    public static final DeferredRegister<Effect> EFFECTS = new DeferredRegister<>(ForgeRegistries.POTIONS, BerserkMod.MOD_ID);
